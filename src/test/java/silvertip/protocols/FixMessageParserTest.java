...
public class FixMessageParserTest {
  ...
  @Test public void missingBeginString() throws Exception {
  ...
  @Test public void missingBodyLength() throws Exception {
  ...
  @Test public void missingMsgType() throws Exception {
